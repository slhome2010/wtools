...
const report_treetable_group = {
	...
	scheme:{
		...
		$group:{
			...
			footer:{
					total:["billing", "sum"],
					row:function(obj ){ return "<span style='float:right;'>Итого: "+webix.i18n.numberFormat(obj.total)+"</span>"; }
				},
		},
	...
	elements:[
		{ cols:[
			...
			{ view:"button", value:"Расчитать", width:120, click:function(){
				...
				billing_treetable.load(function(){return query});
			}},
		]},		
		owner_tree,
	],
...
const controls = [	
	{ view:"button", value:"Назад", width:120, click:function(){ $$("checking-form").show(); } },	
];

...
var layout = {
	...
	"rows": [{
		...
		"legend": {
			"layout": "x",
			"align": "right",
			"values": [{ "text": "Отключено", "color": "#a693eb" }, { "text": "Не работало", "color": "#c71585" }, { "text": "Работало", "color": "#ff00ff" }, { "text": "Подключено", "color": "#63b4ea" }, { "text": "Всего объектов", "color": "#0473B6" }]
		},
		"offset": 0,
		alpha: 0.8,
